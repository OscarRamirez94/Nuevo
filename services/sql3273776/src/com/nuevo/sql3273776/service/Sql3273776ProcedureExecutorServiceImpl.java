...
@Service
public class Sql3273776ProcedureExecutorServiceImpl implements Sql3273776ProcedureExecutorService {

    private static final Logger LOGGER = LoggerFactory.getLogger(Sql3273776ProcedureExecutorServiceImpl.class);

    @Autowired
    @Qualifier("sql3273776WMProcedureExecutor")
